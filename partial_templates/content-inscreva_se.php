...
<div class="content-inscreva_se">
  ...
  <div class="row mt10">
    <div class="col-md-12">
      ...
      <select name="fi_opcao-curso-1" id="fi_opcao-curso-1" class="field-select" style="display: none">
  ...
  <div class="row mt10">
    <div class="col-md-12">
      ...
      <select name="fi_opcao-curso-2" id="fi_opcao-curso-2" class="field-select" style="display: none">
        <?php foreach( $fields_campos as $field ): ?>
          <option value="<?php echo $field; ?>"><?php echo $field; ?></option>
        <?php endforeach; ?>
      </select>
  ...
  <div class="row mt10">
    <div class="col-md-12">
      ...
      <select name="fi_opcao-curso-3" id="fi_opcao-curso-3" class="field-select" style="display: none">
        <?php foreach( $fields_campos as $field ): ?>
          <option value="<?php echo $field; ?>"><?php echo $field; ?></option>
        <?php endforeach; ?>
      </select>
